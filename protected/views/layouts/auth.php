...
<head>
    ...
    <title>
        <? if($this->seo) echo $this->seo->title; else echo $this->pageTitle; ?>
    </title>
...
<body>
        ...
        <div id="sub-header" class="container">
            <div class="row top-text">
                <div class="col-lg-8 col-xs-12">
                    <div title=“QP-kuhni” class="QP-kuhni">
                        <span class="text-style-1">QP</span>
                        <span>-kuhni</span>
                        <br />
                    ...
                    <a href="#" id="callback-navigate" class="Rectangle-3 callback_mob" data-toggle="modal" data-target="#callback-modal" onclick="typeModal('call'); yaCounter31370493.reachGoal('callback-navigate');">
                        <span>ОБРАТНЫЙ ЗВОНОК</span>
                        <img class="img-no-fix" src="/images/main/btn_callback.svg" />
                        <img class="img-fix" src="/images/main/btn_callback_white.svg" style="display:none" />
                    </a>
                    <a href="/" class="Rectangle-3" style="float:left;">
                        <span style="margin-left:35px">НА ГЛАВНУЮ</span>
                        <img src="/images/main/btn_project_yellow.svg" />
                    </a>
                </div>
                <div class="col-lg-2 col-xs-12 infoqp-kuhniru">
                    <img src="/images/main/email.svg" />
                    <a href="mailto:e-mail: info@QP-kuhni.ru">info@qp-kuhni.ru</a>
                </div>
                <div class="col-lg-2 col-xs-12 infoqp-kuhniru">
                    <img src="/images/main/phone.svg" />
                    <a href="tel:+78129529783">8 812 952-97-83</a>
                </div>
            </div>
        </div>
        ...
        <div id="question" style="background: transparent; top:15%">
            <div class="container" style="text-align:center;">
                <div class="row div-form" style="padding: 15px; background: #fff;">
                    <div data-dismiss="modal" id="closeModal" style="float: right; margin-right:20px; font-size: 26px; cursor: pointer;">
                    ...
                    <p class="text" style="font-size:27px; margin-top: 5%">
                        Заполните форму и наш менеджер
                        <br />свяжется с Вами в ближайшее время
                    </p>
                    <form role="form" action="/files/mail/mail.php" method="POST" id="call-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <input type="text" id="phoneF2" name="phone" placeholder="Ваш номер телефона" required />
                            </div>
                            <div class="col-lg-2"></div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="policy" style="color:black;">
                                    Нажимая «Заказать рассчет стоимости», вы даёте согласие на обработку своих
                                ...
                                <button style="background: #ffc500">
                                    <span id="callback-modal-b"></span>
                                    <img src="/images/main/btn_callback_white.svg" style="margin-left:15px; border: 1px silid black" />
                                </button>
                            </div>
                            <div class="col-lg-2"></div>
                        </div>
        ...
        <div class="container" style="text-align:center;">
            <div class="container" style="margin-top:15%; width: 60%; text-align:center;">
                <div class="row div-form" style="background: #fff;">
                    <div>
                        <img src="/images/main/success1.png" width="75px" height="75px" style="margin: 20px 0;" />
                        <p style="font-size: 36px; font-weight:bold">
                            Спасибо!
                            <br />Ваша заявка отправлена!
                        </p>
                    </div>
                    <div data-dismiss="modal" id="closeModal" style="background:rgb(255,197,0,0.5); border-radius:5px; width:60px; margin: 20px auto; font-size: 26px; cursor: pointer;">
    ...
    <div id="footer">
        <div class="container clearfix">
            <div class="row">
                <div class="col-lg-3">
                    <ul>
                        <li>
                            <a href="/gotovye-kuhni">
                                <b>Готовые кухни</b>
                            </a>
                        </li>
                        <li>
                            <a href="/gotovye-kuhni/klassicheskie-kuhni">Классические</a>
                        </li>
                        <li>
                            <a href="/gotovye-kuhni/sovremennye-kuhni">Современные</a>
                        </li>
                        <li>
                            <a href="/gotovye-kuhni/uglovye-kuhni">Угловые</a>
                        </li>
                        <li>
                            <a href="/gotovye-kuhni/pryamye-kuhni">Прямые</a>
                        </li>
                        <li>
                            <a href="/gotovye-kuhni/premium-kuhni">Премиум</a>
                        </li>
                        <li>
                            <a href="/gotovye-kuhni/nedorogie-kuhni">Недорогие</a>
                        </li>
                        <li>
                            <a href="/gotovye-kuhni/p-obraznaya-kuhnya">П-образные</a>
                        </li>
                        <li>
                            <a href="/gotovye-kuhni/kuhnya-s-ostrovkom">С островком</a>
                        </li>
                        <li>
                            <a href="/gotovye-kuhni/kuhnya-s-barnoy-stoykoy">С барной стойкой</a>
                        </li>
                        <li>
                            <a href="/gotovye-kuhni/vstraivaemye-kuhni">Встраиваемые</a>
                        </li>
                    </ul>
                </div>
                <div class="col-lg-3">
                    <ul>
                        <li>
                            <a href="/catalog" title="Модули для кухни">
                                <b>Каталог товаров</b>
                            </a>
                        </li>
                        <li>
                            <a href="/catalog/kitchenmodules" title="Фасады для кухни">Кухонные модули</a>
                        </li>
                        <li>
                            <a href="/catalog/fronts" title="Фасады для кухни">Кухонные фасады</a>
                        </li>
                        <li>
                            <a href="/catalog/stoleshnicy/8" title="Столешницы">Столешницы</a>
                        </li>
                        <li>
                            <a href="/catalog/stenovye-paneli/9" title="Стеновые панели">Стеновые панели</a>
                        </li>
                        <li>
                            <a href="/catalog/kuhonnye-aksessuary/11" title="Аксессуары для кухни">Кухонные аксессуары</a>
                        </li>
                        <li>
                            <a href="/catalog/kuhonnaya-tehnika/12" title="Техника для кухни">Кухонная техника</a>
                        </li>
                        <li>
                            <a href="/catalog/shkafy/62" title="Шкафы">Шкафы</a>
                        </li>
                    </ul>
                </div>
                <div class="col-lg-3">
                    <ul>
                        ...
                        <li>
                            <a href="/how-to" title="Как заказать">Как заказать</a>
                        </li>
                        <li>
                            <a href="/delivery" title="Доставка и сборка">Доставка и сборка</a>
                        </li>
                        <li>
                            <a href="/about" title="О производстве">О производстве</a>
                        </li>
                        <li>
                            <a href="/polezno-znat" title="Все о кухнях">Все о кухнях</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="/advantage" title="Наши преимущества">Наши преимущества</a>
                        </li>
                        <li>
                            <a href="/nashi-raboty" title="Наши сделанные кухни">Наши работы</a>
                        </li>
                        <li>
                            <a href="/nashi-dekory" title="Наши декоры">Наши декоры</a>
                        </li>
                    </ul>
                </div>
                <div class="col-lg-3 data-company">
                    <p class="inn">
                        ООО «КВАЛИТИ ПЕРФОМАНС»
                        <br />
                        ОГРН 1147847178379
                        <br />
                        ИНН 7802860652
                    ...
                    <div>
                        <img src="/images/main/email_footer.svg" />
                        <b style="font-size: 16px;">
                            <a href="mailto:e-mail: info@QP-kuhni.ru">info@qp-kuhni.ru</a>
                        </b>
                    </div>
                    <div style="margin-top:10px">
                        <img src="/images/main/phone_footer.svg" />
                        <b style="font-size: 16px;">
                            <a href="tel:+78129529783">8 812 952-97-83</a>
                        </b>
                    </div>
                    <div style="margin-top:7%;margin-left: -3px;">
                        <a target="_blank" href="https://vk.com/qpkuhni" rel="nofollow">
                            <img src="/images/new/vk.png" style="width:35px; height:35px;" />
                        </a>
                        <a target="_blank" href="https://www.instagram.com/qpkuhni/" rel="nofollow">
                            <img src="/images/new/inst.png" style="width:35px; height:35px;" />
                        </a>
                        <a target="_blank" href="https://twitter.com/qpkuhni" rel="nofollow">
                            <img src="/images/new/tw.png" style="width:35px; height:35px;" />
                        </a>
                        <a target="_blank" href="https://www.facebook.com/qpkuhni" rel="nofollow">
                            <img src="/images/new/f.png" style="width:35px; height:35px;" />
                        </a>
                    </div>
                    ...
                    <div class="pull-left">
                        ...
                        <a href="/profile">Редактирование информации</a>
                        <br />
                    </div>
                    ...
                    <div class="pull-left">
                        ...
                        <a href="/sign-out" style="color: black; border-bottom: 1px dotted black;">ЗАВЕРШЕНИЕ РАБОТЫ</a>
                    </div>
                    <? else: ?>
            ...
            <div class="row" style="text-align:center">
                <p>
                    Информация на данном интернет-сайте носит исключительно ознакомительный
                    <br />
        ...
        <div itemscope itemtype="https://schema.org/Organization" style="display:none;">
            ...
            Телефон:
            <span itemprop="telephone">8 812 952-97-83</span>,
	        Электронная почта:
            <span itemprop="email">info@qp-kuhni.ru</span>
        </div>
        <div class="clr"></div>
    </div>
    ...
    <noscript>
        <div>
            <img src="https://mc.yandex.ru/watch/31370493" style="position:absolute; left:-9999px;" alt="" />
        </div>
    </noscript>
    <!— /Yandex.Metrika counter —>
    ...
    <script type="text/javascript">!function(){var t=document.createElement("script");t.type="text/javascript",t.async=!0,t.src="https://vk.com/js/api/openapi.js?162",t.onload=function(){VK.Retargeting.Init("VK-RTRG-356838-58aVi"),VK.Retargeting.Hit()},document.head.appendChild(t)}();</script>
    <noscript>
        <img src="https://vk.com/rtrg?p=VK-RTRG-356838-58aVi" style="position:fixed; left:-999px;" alt="" />
    </noscript>
    ...
    <?if(stripos($_SERVER['REQUEST_URI'],'/catalog') === false):?>
                ...
                <div class="fancybox-skin" style="padding: 15px; width: auto; height: auto;">
                    <div class="fancybox-outer">
                        <div class="fancybox-inner">
                            <img class="fancybox-image" src="/images/action3.jpg" alt="" />
                        </div>
                    </div>
        ...
        <script defer src="https://feedbackcloud.kupiapp.ru/widget/widget.js" type="text/javascript"></script>
        <script defer type="text/javascript">document.addEventListener("DOMContentLoaded", feedback_vk.init({ id: 'feedback_vk', gid: 100017537 }));</script>
    <?endif;?>
    ...
    <script async type="text/javascript" src="//api.venyoo.ru/wnew.js?wc=venyoo/default/science&widget_id=6585583498690560"></script>
