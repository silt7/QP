<?php $wallPanel = $this->processOutput( $wallPanel );
$colors          = $wallPanel->getColors();
$price           = 0;
...
<div class="container">
	<ol class="breadcrumb">
		...
		<li class="active"><?= $wallPanel->title ?></li>
	</ol>
</div>
<div class="container">
	...
	<div class="row">
		<form id="tabletop-form" method="post">
			<input type="text" hidden="hidden" name="item_id" value="<?= $wallPanel->id ?>">
			...
			<div class="col-sm-10">
				<div class="tabletop-container">
					...
					<h3><?= $wallPanel->title ?></h3></p>
					<div class="col-sm-8 description"><?= $wallPanel->description ?></div>
					<div class="col-sm-4 image"><img src="<?= $wallPanel->getImage() ?>"></div>
					...
					<div class="col-sm-12 colors">
						...
						<? $colorsInRow = 8; ?>
						<? $isRowClose = true; ?>
						<? foreach ( $wallPanel->getColors() as $color ): ?>
							<? if ( $colorCounter == 1 ):
								$isRowClose = false;?>
				...
				<div class="col-sm-12 options" id="tabletop-options">
					<? $group = ""; ?>
					<div class="row">
						<? if ($wallPanel->getOptions()) foreach ($wallPanel->getOptions() as $option): ?>
