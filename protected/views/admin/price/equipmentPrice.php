...
<div class="container">
	<h1 class="head">Загрузка цен техники</h1>

	<form action="/admin/price/SaveEquipmentPrice" method="post" enctype="multipart/form-data">
				...
				<div class="panel panel-default">
					<div class="panel-body">
						<div class="form-group">
							...
							<label>Имя файла должно соответствовать: EquipmentPrice.xlsx </label><a id="loadSh"> (Выгрузить шаблон)</a>
...
<script>
	$("#loadSh").click(function(){
		window.open("../excel/tempPrice/EquipmentPrice.xlsx", '_self');
	})
</script>