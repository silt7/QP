...
class sitemap
{
    ...
    public function generate_sitemap(){
        ...
        foreach($this->sitemap_urls as $url)
        {
            ...
            $url_tag->addChild("lastmod", htmlspecialchars("2016-12-13T17:23:33+03:00"));
            $url_tag->addChild("changefreq", htmlspecialchars("always"));
            $url_tag->addChild("priority", htmlspecialchars("0.8"));
        }
...
//ссылка Вашего сайта:
$sitemap->get_links("https://qp-kuhni.ru");
...
$f = fopen("/home/a0009865/domains/a0009865.xsph.ru/public_html/sitemap.xml","w");
fwrite($f,$map);
fclose($f);
?>